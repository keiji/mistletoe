...
func TestGenerateMistletoeBody(t *testing.T) {
	...
	allPRs := map[string][]PrInfo{
		"repo-a": {{URL: "http://example.com/pr/a", State: "OPEN"}},
		"repo-b": {{URL: "http://example.com/pr/b", State: "OPEN"}},
	}
...
func TestGenerateMistletoeBody_WithDependencies(t *testing.T) {
	...
	allPRs := map[string][]PrInfo{
		"repo-main":  {{URL: "url-main", State: "OPEN"}},
		"repo-dep1":  {{URL: "url-dep1", State: "OPEN"}},
		"repo-dep2":  {{URL: "url-dep2", State: "OPEN"}}, // Depended by main
		"repo-lib":   {{URL: "url-lib", State: "OPEN"}},  // Main depends on lib
		"repo-other": {{URL: "url-other", State: "OPEN"}},
	}
...
func TestGenerateMistletoeBody_WithDependencyContent(t *testing.T) {
	...
	if !strings.Contains(body, "<summary>mistletoe-dependencies-test-id.md</summary>") {
...
func TestDependencyCategorization_Verification(t *testing.T) {
	...
	// 2. Mock PR URLs
	allPRs := map[string][]PrInfo{
		"mstl1": {{URL: "https://github.com/org/mstl1/pull/1", State: "OPEN"}},
		"mstl2": {{URL: "https://github.com/org/mstl2/pull/2", State: "OPEN"}},
		"mstl3": {{URL: "https://github.com/org/mstl3/pull/3", State: "OPEN"}},
	}
