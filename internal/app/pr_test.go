...
func TestCheckGhAvailability(t *testing.T) {
	...
	// Test Success
	if err := checkGhAvailability(false, "gh"); err != nil {
...
func TestVerifyGithubRequirements_Success(t *testing.T) {
	...
	existing, err := verifyGithubRequirements(false, repos, 1, "git", "gh", nil)
	if err != nil {
...
func TestVerifyGithubRequirements_MissingBaseBranch(t *testing.T) {
	...
	_, err := verifyGithubRequirements(false, repos, 1, "git", "gh", nil)
	if err == nil {
