...
For detailed instructions on how to run these tests, including how to build the Docker image with pre-configured authentication, please refer to [manual_tests/README.md](manual_tests/README.md).
